    ...
    <table border="0" cellpadding="0" cellspacing="0" width="600"
        ...
        <tr>
            <td style="padding-top: 20px;">
                <p style="font-size:22px;line-height:28px;margin:40px 0;margin-left: 35px;"><font color="#666666"><b>Dear 4slash user,</b></font></p>

                <p style="font-size:18px;line-height:28px;margin:20px 0;padding:0 40px"><font color="#666666">We have reset your password as required.
                        In order to use your account again, you need to set up a new password. Click on the following link:
                         {{ url('password/reset/'.$token) }}
                    </font>
                </p>
                <p style="font-size:16px;line-height:28px;margin:40px 0;margin-left: 35px;">
                    The link does not work? Just try it: copy or paste the link into the browser window.  </p>
