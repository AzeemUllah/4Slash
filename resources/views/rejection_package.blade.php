    ...
    <table border="0" cellpadding="0" cellspacing="0" width="600"
        ...
        <tr>
            <td style="padding-top: 20px;">
                ...
                <p style="font-size:22px;line-height:28px;margin:40px 0;margin-left: 35px;"><font color="#666666">Your favor was not accepted. Please change your offer according to our 4slash guidelines.</font></p>

                <p style="font-size:22px;line-height:28px;margin:40px 0;margin-left: 35px;"><font color="#666666"><b>Reason : {{ $reason }}</b></font></p>
                <p style="font-size:18px;line-height:28px;margin:20px 0;padding:0 40px"><font color="#666666">   For further information, please contact us via our contact form.
