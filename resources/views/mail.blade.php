    ...
    <table border="0" cellpadding="0" cellspacing="0" width="600"
        ...
        <tr>
            <td style="padding-top: 20px;">
                <p style="font-size:22px;line-height:28px;margin:40px 0;margin-left: 35px;"><font color="#666666"><b>Dear 4slash customer, {{ $user }},</b></font></p>

                <p style="font-size:18px;line-height:28px;margin:20px 0;padding:0 40px"><font color="#666666">Thank you for your trust and your order " {{ $gig }}"With the order number {{
                        $order_no }}
                        am  {{ date('d.m.Y', strtotime($date)) }}.
                    </font>
                </p>
                <p style="font-size:22px;line-height:28px;margin:40px 0;margin-left: 35px;"> <a href="{{route('myorders', ['orderno' => $order_no])}}" target="_blank">Here you will find your order in the overview!</a> </p>
                <p style="font-size:18px;line-height:28px;margin:20px 0;padding:0 40px"><font color="#666666">For further information, you can contact us at any time via our contact form<p style="font-size:18px;line-height:28px;margin:20px 0;padding:0 40px"><font color="black"><a href=" {{ route('contact') }}" class="btn-primary" style="text-decoration: none; margin-top:
65px; padding: 15px 18px; border-radius: 5px; border: 0px; transition: all 0.8s ease 0s; background: #367fa9;">Contact</a>
                    </font>
                </p>
            </td>
        </tr>
        ...
        <tr>
            <td>
                <p style="font-size:22px;line-height:28px;margin:40px 0;margin-left: 35px;"><font color="#666666"><b>Dear Customer , {{ $user }},</b></font></p>

                <p style="font-size:18px;line-height:28px;margin:20px 0;padding:0 40px"><font color="#666666">
                        Thank you for your trust and your order " {{ $gig }}" With the order number {{$order_no }}
                        at  {{ date('d.m.Y', strtotime($date)) }}.
                    </font>
                </p>
                <p style="font-size:22px;line-height:28px;margin:40px 0;margin-left: 35px;"> <a href="{{route('myorders', ['orderno' => $order_no])}}" target="_blank">Here you will find your order in the overview!</a> </p>
                <p style="font-size:18px;line-height:28px;margin:20px 0;padding:0 40px"><font color="#666666">
                        For further information, please contact us at any time via our contact form <p style="font-size:18px;line-height:28px;margin:20px 0;padding:0 40px"><font color="black"><a href=" {{ route('contact') }}" class="btn-primary" style="text-decoration: none; margin-top:
65px; padding: 15px 18px; border-radius: 5px; border: 0px; transition: all 0.8s ease 0s; background: #367fa9;">Contact</a>
                    </font>
                </p>
            </td>
