        ...
        <table border="0" cellpadding="0" cellspacing="0" width="600"
            ...
            <tr>
                <td align="bottom" style="text-align:center!important">
                    <a href="https://4slash.com/" style="text-decoration:none" target="_blank"></a>
                </td>
            </tr>
                ...
                <tr>
                    <td style="padding-top: 20px;">
                        ...
                        <p style="font-size:18px;line-height:28px;margin:20px 0;padding:0 40px"><font color="#666666">
                                Hello {{ $user }} Looks like you missed your estimated delivery deadline for <a href="{{route('myorders', ['orderno' => $order_no]) }}">{{ $order_no }}</a>.
                            </font>
                        </p>
                        <p>Please deliver the order asap as this will effect your profile status. </p>
                        <p>Thanks,</p>
                    </td>
                </tr>
            @endif
