                        ...
                        @foreach($gigstypes as $gig)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-success btn-xs fa fa-undo undo-btn" data-toggle="modal" data-id="{{ $gig->id }}" data-target="#undoModal"></button>


{{--
                                    <button data-id="{{ $gig->id }}" data-url="{{ route('adminCatGigDelete') }}" class="btn btn-danger btn-xs btn-del"><span class="fa fa-trash-o"></span></button>
--}}
                                </td>
                            </tr>
                        @endforeach
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h3>Are you sure want to restore this gig?</h3>
