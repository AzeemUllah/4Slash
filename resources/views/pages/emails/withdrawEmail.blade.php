    ...
    <table border="0" cellpadding="0" cellspacing="0" width="600"
        ...
        <tr>
                ...
                <tr>
                    <td style="padding-top: 20px;">
                        ...
                        <p style="font-size:18px;line-height:28px;margin:20px 0;padding:0 40px"><font color="#666666">
                                Our customer{{ $user }} hAt sent a withdraw request quantity €{{ $amount }} <a href="{{route('admin.agency', ['agencyMail' => $email]) }}">[Click here]</a>.
                            </font>
                        </p>
                    </td>
                </tr>
            @elseif(!empty($type) && $type == 'agency')
                <tr>
                    <td>
                        <p style="font-size:22px;line-height:28px;margin:40px 0;margin-left: 35px;"><font color="#666666"><b>Dear 4slash Team, {{ $user }}</b></font></p>
                        <p style="font-size:18px;line-height:28px;margin:20px 0;padding:0 40px"><font color="#666666">
                                Your withdraw amount request from ${{ $amount }} Has accepted, and go through the 4slash team
                            </font>
                        </p>
                    </td>
                </tr>
