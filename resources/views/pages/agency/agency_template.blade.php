...
{{--<link rel="shortcut icon" href="">--}}
    ...
    <!-- jQuery 2.1.4 -->
    <!-- uplodify-->
    <link rel="stylesheet" href="{{ URL::asset('css/uploadify.css') }}" type="text/css">
    ...
    <link rel="stylesheet" href="{{ asset('css/jquery.onoff.css') }}">
    <link rel="stylesheet" href="{{ asset('bower_components/AdminLTE/dist/css/skins/style.css') }}">
    <!-- Link Swiper's CSS -->
    <link rel="stylesheet" href="{{ asset('bower_components/AdminLTE/bootstrap/css/jquery.filer.css') }}">
    <link rel="stylesheet" href="{{ asset('bower_components/AdminLTE/bootstrap/css/jquery.filer-dragdropbox-theme.css') }}">
    <link rel="stylesheet" href="{{ asset('bower_components/AdminLTE/dist/css/jquery-ui.min.css') }}">
