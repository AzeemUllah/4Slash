...
@if(!empty($type) && $type == 'user')
        ...
        <tr>
            <td style="padding-top: 20px;">
                ...
                <p style="font-size:18px;line-height:28px;margin:20px 0;padding:0 40px"><font color="#666666">
                        Your order with the order number {{ $order_no }}
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="600"
            ...
            <tr>
                <td style="padding-top: 20px;">
                  ...
                  {{--  <p style="font-size:22px;line-height:28px;margin:40px 0;margin-left: 35px;"> <a href="{{route('myorders', ['orderno' => $order_no])}}" target="_blank">Hier findest du deine Bestellung in der Übersicht!</a> </p>
                    <p style="font-size:18px;line-height:28px;margin:20px 0;padding:0 40px"><font color="#888888">   Für weitere Informationen kannst du uns jederzeit kontaktieren
                            über support@4slash.com oder über unser Kontaktformular <p style="font-size:18px;line-height:28px;margin:20px 0;padding:0 40px"><font color="#888888"><a href=" {{ route('contact') }}" class="btn-primary" style="background-color: #f4bf21; text-decoration: none; margin-top:
...
0s; color:#FFFFFF;">Kontakt</a>.
    ...
    @elseif(!empty($type) && $type == 'agency')
        <table border="0" cellpadding="0" cellspacing="0" width="600"
            ...
            <tr>
                <td>
                    <p style="font-size:22px;line-height:28px;margin:40px 0;margin-left: 35px;"><font color="#666666"><b>Dear 4slash Admin, {{ $agency }}, </b></font></p>
...
0s; color:#FFFFFF;">Contact</a>
            ...
            <tr>
                <td style="border-top-color:#eee;border-top-width:4px;border-top-style:solid;">
                    <p style="font-size:18px;line-height:28px;margin:40px 0;margin-left: 35px;"><font color="#666666"><b>Dear 4slash Partner, {{ $agency }}, </b></font></p>

                    <p style="font-size:18px;line-height:28px;margin:20px 0;padding:0 40px"><font color="#666666">
                            the canceled job {{ $order_no }} of the client {{ $user }} will be refunded 100% . This job is not provisioned.
                        </font>
                    </p>
                    <p style="font-size:18px;line-height:28px;margin:20px 0;padding:0 40px"><font color="#666666">
