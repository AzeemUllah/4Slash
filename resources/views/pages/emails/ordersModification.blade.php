...
<div class="container" style="margin-top: 20px;">
    ...
    @if(!empty($mail_status) && $mail_status == 'modification')
        <table border="0" cellpadding="0" cellspacing="0" width="600"
                ...
                <tr>
                    <td style="padding-top: 20px;">
                        ...
                        <p style="font-size:18px;line-height:28px;margin:20px 0;padding:0 40px"><font color="#666666">
                                Our customer {{ $user }} Has sent a request for changes to <a href="{{route('myorders', ['orderno' => $order_no]) }}">{{ $order_no }}</a>.
                            </font>
                        </p>
                    </td>
                </tr>
            @elseif(!empty($type) && $type == 'agency')
                <tr>
                    <td>
                        <p style="font-size:22px;line-height:28px;margin:40px 0;margin-left: 35px;"><font color="#666666"><b>Dear 4slash Team, {{ $agency }}</b></font></p>
                        <p style="font-size:18px;line-height:28px;margin:20px 0;padding:0 40px"><font color="#666666">
                                Our customer {{ $user }} Has sent a request for changes to <a href="{{route('agencySingleOrder', ['orderno' => $order_no, 'orderuuid' => $orderUUID]) }}">{{ $order_no }}</a>.
                            </font>
                        </p>
                    </td>
                </tr>
