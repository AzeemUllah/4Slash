...
<div class="container" style="margin-top: 20px;">
    ...
    <div class="col-md-12 col-md-offset-3" style="padding-top: 50px; padding-bottom: 40px;  max-width: 600px;">
        <div class="col-md-10 col-md-offset-1" style="background-color: white;    margin-top: -35px">
            @if(!empty($confirmed) && $confirmed == 'confirmmail')
                <table border="0" cellpadding="0" cellspacing="0" width="600"
                    ...
                    <tr>
                        <td style="padding-top: 20px;">
                            <p style="font-size:16px;line-height:28px;margin:20px 0;padding:0px 40px"><font color="#666666">
                                    Congratulations! A new user,  {{ $user }}, Has successfully activated its user account. <span style="font-weight: bold"> {{ $user }} </span> Is now part of the 4slash community.
                                </font>
                            </p>
                            <p style="font-size:16px;line-height:28px;margin:20px 0;padding:0 40px"><font color="#666666">
                                    Best regards
                                </font>
                            </p>
                            <p style="font-size:16px;line-height:28px;margin:20px 0;padding:0 40px"><font color="#666666"> Your 4slash system
                                </font>
                            </p>
                        </td>
                    </tr>
                </table>
            @elseif(!empty($registered) && $registered == 'doneregister' )
                <table border="0" cellpadding="0" cellspacing="0" width="600"
                       style="overflow:hidden;border-radius:4px;border-collapse:collapse!important;width: 100%;">
                    <tbody>
                    <tr>
                    ...
                    <tr>
                        <td style="padding-top: 20px;">
                            <p style="font-size:20px;line-height:28px;margin:40px 0;margin-left: 40px;"><font color="#666666"><b>Dear 4slash customer, {{ $user }},</b></font></p>
                            <p style="font-size:16px;line-height:28px;margin:20px 0;padding:0 40px"><font color="#666666">
                                    {{--herzlichen Glückwunsch! Sie haben erfolgreich registriert, um Ihr Konto zu aktivieren, bitte klicken Sie den folgenden Link:<br>--}}
                                    Thank you for your registration.<br>
                                </font>
                            </p>
                            <p style="font-size:16px;line-height:28px;margin:20px 0;padding:0 40px"><font color="#666666">
                                    For further information, you can contact us at any time
                                    via our contact form<p style="font-size:18px;line-height:28px;margin:20px 0;padding:0 40px"><font color="#888888"><a href="https://4slash.zendesk.com" class="btn-primary" style="text-decoration: none; margin-top:
65px; padding: 15px 18px; border-radius: 5px; border: 0px; transition: all 0.8s ease 0s; background: #367fa9; color: white;">Contact us</a>
                    ...
                    <tr>
                        <td>
                            <p style="font-size:16px;line-height:28px;margin:20px 0;padding:0 40px"><font color="#666666">Best Regards</font></p>
                            <p style="font-size:16px;line-height:28px;margin:20px 0;padding:0 40px"><font color="#666666">
                                    4slash Team
                                </font>
                            </p>
