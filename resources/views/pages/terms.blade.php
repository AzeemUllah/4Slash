    ...
    <section class="section">
        <div class="container">
            ...
            <div class="accordion" id="accordion-general">
                <div class="card">
                    <h5 class="card-title">
                        <a data-toggle="collapse" data-parent="#accordion-general" href="#collapse-general-1">What is 4slash?</a>
                    </h5>
                ...
                <div class="card">
                    <h5 class="card-title">
                        <a data-toggle="collapse" data-parent="#accordion-general" href="#collapse-general-2">Where can I learn more about how to use The4slash?</a>
                    </h5>
                ...
                <div class="card">
                    <h5 class="card-title">
                        <a data-toggle="collapse" data-parent="#accordion-general" href="#collapse-general-5">What is The 4slash approach to data privacy?</a>
                    </h5>
            ...
            <div class="accordion" id="accordion-license">
                ...
                <div class="card">
                    ...
                    <div id="collapse-license-2" class="collapse">
                        <div class="card-block">
                            Extended license can be used for end products(web service or 4slash) that charges users for access or service(e.g: monthly subscription fee). Single extended license can be used for single end product and end product can be used by you or your client. If you want to sell end product to multiple clients then you will need to purchase separate extended license for each client. The same rule applies if you want to use the same end product on multiple domains(unique setup).
                        </div>
                    </div>
                </div>
    ...
    <section class="section">
        <div class="container">
            ...
            <div class="accordion" id="accordion-payment">
                <div class="card">
                    <h5 class="card-title">
                        <a data-toggle="collapse" data-parent="#accordion-payment" href="#collapse-payment-1">Can I use The4slash for free?</a>
                    </h5>
