...
<div class="container" style="margin-top: 20px;">
    ...
    @if(!empty($adminJobDone) && $adminJobDone == 'adminDone')
        ...
        <tr>
            <td style="padding-top: 20px;">
                ...
                <p style="font-size:18px;line-height:28px;margin:20px 0;padding:0 40px"><font color="#666666">
                        If you want a change click on <a href="{{route('myorders', ['orderno' => $order_no]) }}">assignment</a>„
                ...
                <p style="font-size:18px;line-height:28px;margin:20px 0;padding:0 40px"><font color="#666666">   For further information, you can contact us at any time
                         via our contact form <p style="font-size:18px;line-height:28px;margin:20px 0;padding:0 40px"><font color="#888888"><a href=" {{ route('contact') }}" class="btn-primary" style="text-decoration: none; margin-top:
...
0s; color:#FFFFFF;">Contact</a>
    ...
    @elseif(!empty($mail) && $mail == 'acknowledge')
        <table border="0" cellpadding="0" cellspacing="0" width="600"
               style="overflow:hidden;border-radius:4px;border-collapse:collapse!important;width: 100%;">
            <tbody>
            <tr>
            ...
            <tr>
                <td style="padding-top: 20px;">
                    <p style="font-size:22px;line-height:28px;margin:40px 0;margin-left: 35px;"><font color="#666666"><b>Dear 4slash customer, {{ $user }},</b></font></p>
                    <p style="font-size:18px;line-height:28px;margin:20px 0;padding:0 40px"><font color="#666666">
                            your order<a href="{{route('myorders', ['orderno' => $order_no]) }}">{{ $order_no }}</a> Has been successfully completed.
                        </font>
                    </p>
                    ...
                    <p style="font-size:18px;line-height:28px;margin:20px 0;padding:0 40px"><font color="#666666"> For further information, you can contact us at any time
                            Via order@4slash.com or via our contact form <p style="font-size:18px;line-height:28px;margin:20px 0;padding:0 40px"><font color="#888888"><a href=" {{ route('contact') }}" class="btn-primary" style="text-decoration: none; margin-top:
65px; background-color: #367fa9; padding: 15px 18px; border-radius: 5px; border: 0px; transition: all 0.8s ease
0s; color:#FFFFFF;">Contact</a>
                        </font>
                    </p>
            ...
            @elseif(!empty($type) && $type == 'agency')
                <tr>
                    <td>
                        <p style="font-size:22px;line-height:28px;margin:40px 0;margin-left: 35px;"><font color="#666666"><b>Dear 4slash partner, {{ $agency }},</b></font></p>
                        <p style="font-size:18px;line-height:28px;margin:20px 0;padding:0 40px"><font color="#666666">
                                Congratulations. Our customer {{$user}}  Has the following order
                                <a href="{{route('myorders', ['orderno' => $order_no]) }}">{{ $order_no }}</a>
            ...
            @elseif(!empty($type) && $type == 'admin')
                <tr>
                    <td>
                        ...
                        <p style="font-size:18px;line-height:28px;margin:20px 0;padding:0 40px"><font color="#666666">
                                Congratulations. Our customer {{ $user }}Has the following order <a href="{{route('myorders', ['orderno' => $order_no]) }}">{{ $order_no }}</a>
