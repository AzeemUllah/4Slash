...
<head>
    ...
    <meta charset="UTF-8">
    <meta name="keywords" content="Graphics & Design,graphic art, Digital Marketing,online marketing,web marketing, Writing & Translation, Video & Animation,video maker,movie maker,video editor, Music & Audio,stock music,stock audio, Programming & Tech, Advertising,ads,online advertising,business advertising,Business & Writting,business writing skills, Favors">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/cnerr-app.min.css') }}">
    ...
    <link rel="stylesheet" type="text/css"
          ...
          type='text/css'>
    <link rel="stylesheet" type="text/css" href="{{ asset('css/bootstrap-social.min.css') }}">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/A-style.min.css') }}">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('css/Z-style.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('css/c-style.min.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ asset('css/jquery.mCustomScrollbar.min.css') }}">
    <link rel="stylesheet" href="{{ asset('css/uploadify.min.css') }}" type="text/css">
    <link rel="stylesheet" href="{{ asset('css/social-share-kit.css') }}" type="text/css">
    <!-- Link Swiper's CSS -->
    <link rel="stylesheet" href="{{ asset('css/jquery.filer.min.css') }}">
    <link rel="stylesheet" href="{{ asset('css/jquery.filer-dragdropbox-theme.min.css') }}">
{{--<link rel="stylesheet" href="{{ asset('css/swiper.min.css') }}">--}}

<!-- Custom CSS -->
    <link href="{{ asset('css/half-slider.min.css') }}" rel="stylesheet">
    <link href="{{ asset('css/sam_style.min.css') }}" rel="stylesheet">
...
<body ng-app="cnerr" style="    font-family: proxima-nova,Helvetica Neue,Helvetica,sans-serif !important;">
