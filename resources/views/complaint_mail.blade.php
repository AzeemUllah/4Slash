    ...
    <table border="0" cellpadding="0" cellspacing="0" width="600"
        ...
        <tr>
            <td style="padding-top: 20px;">
                <p style="font-size:22px;line-height:28px;margin:40px 0;margin-left: 40px;"><font color="#666666"><b></b></font></p>
                <p style="font-size:22px;line-height:28px;margin:40px 0;margin-left: 40px;"><font color="#666666" style="font-size: 13px;"><b>Order# : </b>{{ $order_no }}</font></p>
                <p style="font-size:22px;line-height:28px;margin:40px 0;margin-left: 40px;"><font color="#666666" style="font-size: 13px;"><b>Complaint : </b>{{ $complaint }}</font></p>
